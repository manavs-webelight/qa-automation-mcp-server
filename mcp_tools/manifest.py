...
async def register_recording(
    ...
    success_conditions: list[dict] | None = None,
) -> dict:
    ...
    Args:
        ...
        goal: Required. The automation goal (e.g. "Complete associate hire wizard").
        description: Required. Description of what the recording does, including any exclusions.
        success_conditions: List of success condition objects. Auto-generated by agent if not provided.
    ...
    if not goal:
        return {"status": "error", "error": "missing_goal", "message": "goal is required for registration"}
    if not description:
        return {"status": "error", "error": "missing_description", "message": "description is required for registration"}
